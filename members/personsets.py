...
sp_mp_matches = {
    ...
    # Ben Wallace
    "uk.org.publicwhip/member/80251": "Ben Wallace [Lancaster and Wyre]",
    # David Mundell
...
# Doesn't matter if they actually win or not, can remove the ones who don't afterwards
    ...
    "Angela Smith {Basildon}" : "Angela Smith {Basildon / South Basildon and East Thurrock}",
    "Angela Smith {South Basildon and East Thurrock}" : "Angela Smith {Basildon / South Basildon and East Thurrock}",
    ...
    "Steve McCabe {Birmingham, Hall Green}" : "Steve McCabe {Birmingham, Hall Green / Birmingham, Selly Oak}",
    "Steve McCabe {Birmingham, Selly Oak}" : "Steve McCabe {Birmingham, Hall Green / Birmingham, Selly Oak}",
    ...
    "Terry Rooney {Bradford North}" : "Terry Rooney {Bradford North / Bradford East}",
    "Terry Rooney {Bradford East}" : "Terry Rooney {Bradford North / Bradford East}",
    "Dawn Butler {Brent South}" : "Dawn Butler {Brent South / Brent Central}",
    "Dawn Butler {Brent Central}" : "Dawn Butler {Brent South / Brent Central}",
    ...
    "Julia Goldsworthy {Falmouth and Camborne}" : "Julia Goldsworthy {Falmouth and Camborne / Camborne and Redruth}",
    "Julia Goldsworthy {Camborne and Redruth}" : "Julia Goldsworthy {Falmouth and Camborne / Camborne and Redruth}",
    ...
    "Douglas Carswell {Harwick}" : "Douglas Carswell {Harwick / Clacton}",
    "Douglas Carswell {Clacton}" : "Douglas Carswell {Harwick / Clacton}",
    ...
    "Paul Clark {Gillingham}" : "Paul Clark {Gillingham / Gillingham and Rainham}",
    "Paul Clark {Gillingham and Rainham}" : "Paul Clark {Gillingham / Gillingham and Rainham}",
    ...
    "Sir Malcolm Rifkind {Kensington and Chelsea}" : "Sir Malcolm Rifkind {Kensington and Chelsea / Kensington}",
    "Sir Malcolm Rifkind {Kensington}" : "Sir Malcolm Rifkind {Kensington and Chelsea / Kensington}",
    ...
    "Phyllis Starkey {Milton Keynes South West}" : "Phyllis Starkey {Milton Keynes South West / Milton Keynes South}",
    "Phyllis Starkey {Milton Keynes South}" : "Phyllis Starkey {Milton Keynes South West / Milton Keynes South}",
    "Ed Balls {Normanton}" : "Ed Balls {Normanton / Morley and Outwood}",
    "Ed Balls {Morley and Outwood}" : "Ed Balls {Normanton / Morley and Outwood}",
    "Nicholas Brown {Newcastle Upon Tyne East and Wallsend}" : "Nicholas Brown {Newcastle Upon Tyne East and Wallsend / Newcastle Upon Tyne East}",
    "Nicholas Brown {Newcastle Upon Tyne East}" : "Nicholas Brown {Newcastle Upon Tyne East and Wallsend / Newcastle Upon Tyne East}",
    "Richard Younger-Ross {Teignbridge}" : "Richard Younger-Ross {Teignbridge / Newton Abbot}",
    "Richard Younger-Ross {Newton Abbot}" : "Richard Younger-Ross {Teignbridge / Newton Abbot}",
    ...
    "Alison Seabeck {Plymouth, Devonport}" : "Alison Seabeck {Plymouth, Devonport / Plymouth Moor View}",
    "Alison Seabeck {Plymouth Moor View}" : "Alison Seabeck {Plymouth, Devonport / Plymouth Moor View}",
    "Linda Gilroy {Plymouth, Sutton}" : "Linda Gilroy {Plymouth, Sutton / Plymouth Sutton and Devonport}",
    "Linda Gilroy {Plymouth Sutton and Devonport}" : "Linda Gilroy {Plymouth, Sutton / Plymouth Sutton and Devonport}",
    ...
    "George Galloway {Bethnal Green and Bow}" : "George Galloway {Bethnal Green and Bow / Poplar and Limehouse}",
    "George Galloway {Poplar and Limehouse}" : "George Galloway {Bethnal Green and Bow / Poplar and Limehouse}",
    ...
    "Sandra Gidley {Romsey}" : "Sandra Gidley {Romsey / Romsey and Southampton North}",
    "Sandra Gidley {Romsey and Southampton North}" : "Sandra Gidley {Romsey / Romsey and Southampton North}",
    ...
    "Dr Liam Fox {Woodspring}" : "Dr Liam Fox {Woodspring / North Somerset}",
    "Dr Liam Fox {North Somerset}" : "Dr Liam Fox {Woodspring / North Somerset}",
    "Dan Norris {Wansdyke}" : "Dan Norris {Wansdyke / North East Somerset}",
    "Dan Norris {North East Somerset}" : "Dan Norris {Wansdyke / North East Somerset}",
