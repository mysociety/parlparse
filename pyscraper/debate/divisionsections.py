...
rehousediv_england = re.compile('<p[^>]*>(?:<i>)?Votes cast by Members for constituencies in England(?: and Wales)?:(?:\s|</i>)*</p>$')
...
regenddiv = '''(?x)(
    (?:Mr|The)[ ](?:Deputy[ ])?Speaker[ ]declared
    | Question[ ]accordingly
    | It[ ]appearing[ ]on[ ]the[ ][Rr]eport
    | %s
)''' % strexplicitenddiv
