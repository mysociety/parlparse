...
def SplitLordsText(text, sdate):
	...
	if sdate != '2007-10-01' and sdate != '2008-09-29' and sdate != '2009-10-05' and sdate != '2010-09-27' and not re.search('(?:<ul><ul><ul>|<ul><ul><p>|\s*(?:<ul>|<p>)?|<p>\s*<ul><ul>(?:<ul>)?)\s*(?:Parliament was prorogued|House adjourned |For the continuation of today\'s proceedings)(?i)', res[0]):
