...
def api_field_to_uni_detail(field: CommonsAPIFieldModel) -> RegmemDetail:
    ...
    if field.values:
        ...
        for subitem_list in field.values or []:
            ...
            for item in subitem_list:
                items_to_add.append(api_field_to_uni_detail(item))
...
def api_interest_to_uni_regmem_item(
    ...
    for child in api_interest.child_items:
        uni_interest.sub_entries.append(
            api_interest_to_uni_regmem_item(child, entry_type="subentry")
        )
